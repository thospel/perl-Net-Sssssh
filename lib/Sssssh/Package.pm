package Sssssh::Package;
# $HeadURL: xxx/lib/Sssssh/Package.pm $
# $Id: xxx $
...
$VERSION = "1.000";
$SUB_VERSION = "022";
$release_time = 1617241963;	## no critic (UselessNoCritic MagicNumbers)
%history = (
  'Changes' => {
    '1.000' => '1.000'
  },
...
=for stopwords Sssssh globals

=head1 NAME

Sssssh::Package - Version and history of Sssssh

=head1 SYNOPSIS

  use Sssssh::Package;

  $epoch_time = Sssssh::Package->release_time();

  $package_version = Sssssh::Package->VERSION;

  $min_package_version = Sssssh::Package::released($module, $module_version);
...
=item X<release_time>$epoch_time = Sssssh::Package->release_time()
...
=item X<VERSION>$package_version = Sssssh::Package->VERSION
...
=item X<released>$min_package_version = Sssssh::Package::released($module, $module_version)
