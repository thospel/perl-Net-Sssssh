...
$VERSION = "1.000";
$SUB_VERSION = "064";
$release_time = 1621178883;	## no critic (UselessNoCritic MagicNumbers)
%history = (
  'Changes' => {
    '1.000' => '1.000'
  },
...
=for stopwords Net::Sssssh globals

=head1 NAME

Net::Sssssh::Package - Version and history of Net::Sssssh

=head1 SYNOPSIS

  use Net::Sssssh::Package;

  $epoch_time = Net::Sssssh::Package->release_time();

  $package_version = Net::Sssssh::Package->VERSION;

  $min_package_version = Net::Sssssh::Package::released($module, $module_version);
...
=item X<release_time>$epoch_time = Net::Sssssh::Package->release_time()
...
=item X<VERSION>$package_version = Net::Sssssh::Package->VERSION
...
=item X<released>$min_package_version = Net::Sssssh::Package::released($module, $module_version)
